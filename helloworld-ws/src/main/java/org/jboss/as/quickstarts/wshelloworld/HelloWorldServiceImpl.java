...
import org.jboss.jbossas.quickstarts.wshelloworld.helloworld.MyDummyPOJO;
...
public class HelloWorldServiceImpl implements HelloWorldService {
    ...
    @Override
    public String testObject(MyDummyPOJO pojo) {
    	return "Hello: " + pojo.getId() + "|" + pojo.getName() + "|" + pojo.getMessage();
    }
    
    @Override
    public MyDummyPOJO testObjectReturn(MyDummyPOJO pojo) {
    	pojo.setMessage("WS Impl applied");
    	return pojo;
    }
